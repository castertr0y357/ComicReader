...
class ComicSeries(models.Model):
    ...
    publisher = models.CharField(max_length=50, default="", null=True, blank=True)
...
class ComicBook(models.Model):
    id = models.AutoField(primary_key=True)
    series_name = models.CharField(max_length=100, default="", null=True, blank=True)
    ...
    issue_year = models.CharField(max_length=4, default="", null=True, blank=True)
    issue_month = models.CharField(max_length=2, default="", null=True, blank=True)
    issue_day = models.CharField(max_length=2, default="", null=True, blank=True)
    story_arc = models.ForeignKey(StoryArc, on_delete=models.SET_NULL, null=True, blank=True)
